  ...
  return (
    <div className="container">
      ...
      <p className="page-intro">
        ...
        Feel free to reach out using the form below or connect with me via email or social media.
      </p>
      ...
      <div className="contact-info">
        <p>Email: <a href="mailto:oziomammesoma@gmail.com">oziomammesoma@gmail.com</a></p>
        <p>Lagos, Nigeria</p>
      </div>
      ...
      <div className="social-links" style={{ display: 'flex', gap: '20px', marginTop: '20px' }}>
        ...
        <a
          href="https://github.com/soso-oma"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="GitHub"
        >
